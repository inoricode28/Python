...
qtCreatorFile = 'PaqueteAlumno/frmAlumno.ui' #ruta donde esta estar la interfas UI
Ui_MainWindow,QtBaseClass = uic.loadUiType(qtCreatorFile)
class FormularioAlumno(QtWidgets.QMainWindow):
    def __init__(self,parent = None):
        super(FormularioAlumno, self).__init__(parent)
        uic.loadUi('PaqueteAlumno/frmAlumno.ui',self) #ruta donde esta estar la interfas UI
